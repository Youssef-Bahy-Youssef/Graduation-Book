...
\begin{enumerate}
  ...
  The Media context shall orchestrate Mux direct uploads, persist \texttt{VideoAsset} entities tracking provider identifiers and status (\texttt{AWAITING\_UPLOAD}, \texttt{UPLOADED}, \texttt{TRANSCODING}, \texttt{READY}, \texttt{FAILED}), process signed Mux webhooks idempotently, associate ready assets with lessons, and issue signed playback tokens restricted to enrolled students.
