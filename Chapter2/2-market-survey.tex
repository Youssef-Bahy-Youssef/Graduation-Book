...
\begin{table}[H]
  ...
  \resizebox{\textwidth}{!}{%
  \begin{tabular}{@{}p{2.0cm} c c c c c p{2.2cm}@{}}
    \toprule
    \textbf{Platform} &
    \textbf{Open Source} &
    \textbf{AI Features} &
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.90\textwidth]{images/competitive_positioning.pdf}
...
Figure~\ref{fig:market-segments} contextualises NexaLearn's target market within the broader e-learning landscape. Corporate e-learning and higher education dominate in market size, consistent with NexaLearn's primary and secondary customer segments (Section~\ref{sec:targeted-customers}). The STEM and coding segment---at \$11B---represents a growing overlap with the developer-adoption funnel described in the business case (Section~\ref{sec:business-case}).

\begin{figure}[H]
  \centering
  \includegraphics[width=0.88\textwidth]{images/market_segments.pdf}
  \caption{Global E-Learning Market by Segment (2025). Data sources: HolonIQ, Statista Global EdTech Market Report, Grand View Research.}\label{fig:market-segments}
\end{figure}
