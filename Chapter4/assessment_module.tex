...
export class QuizEntity {
  ...
  gradeAttempt(
    ...
    return QuizAttemptEntity.create({
      ...
      score,
      passed,
      status: hasPendingGrading ? AttemptStatus.GRADING : AttemptStatus.COMPLETED,
    });
  }
}
\end{lstlisting}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{images/statemachines/quiz_attempt_statemachine.png}
