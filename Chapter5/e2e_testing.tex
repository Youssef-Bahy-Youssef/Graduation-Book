...
\begin{table}[H]
  ...
  \small
  \begin{tabular}{@{}p{3.5cm} p{1.8cm} p{\dimexpr\textwidth-6.3cm\relax}@{}}
    \toprule
    ...
    \midrule
    \textbf{Total: 9 files, 50 test cases}  & (3 roles)       & All passed \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{images/e2e_enrollment_flow.pdf}
