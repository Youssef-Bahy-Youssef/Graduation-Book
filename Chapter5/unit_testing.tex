...
\begin{table}[H]
  ...
  \begin{tabular}{llrrr}
    ...
    \midrule
    Auth               & \texttt{user.entity.spec.ts}        & 12             & 98             & 100.0 \\
    Auth               & \texttt{session.entity.spec.ts}      & 8              & 72             & 100.0 \\
    Auth               & \texttt{hmac-signature.service.spec.ts} & 10         & 85             & 97.6 \\
    Courses            & \texttt{course.entity.spec.ts}       & 14             & 156            & 98.1 \\
    Courses            & \texttt{module.entity.spec.ts}       & 6              & 64             & 100.0 \\
    Courses            & \texttt{lesson.entity.spec.ts}       & 8              & 81             & 95.1 \\
    Media              & \texttt{video-asset.entity.spec.ts}  & 10             & 112            & 96.4 \\
    AI Pipeline        & \texttt{transcription-job.entity.spec.ts} & 8          & 74             & 100.0 \\
    AI Pipeline        & \texttt{quiz-generation-job.entity.spec.ts} & 8        & 76             & 100.0 \\
    Assessment         & \texttt{quiz.entity.spec.ts}         & 16             & 198            & 99.5 \\
    Assessment         & \texttt{question.entity.spec.ts}     & 8              & 62             & 100.0 \\
    Assessment         & \texttt{quiz-attempt.entity.spec.ts} & 10             & 134            & 97.0 \\
    Assessment         & \texttt{quiz-grading.service.spec.ts} & 12            & 156            & 98.7 \\
    Payment            & \texttt{payment-intent.entity.spec.ts} & 10           & 118            & 96.6 \\
    Enrollment         & \texttt{enrollment.entity.spec.ts}   & 8              & 92             & 100.0 \\
    Enrollment         & \texttt{streak.service.spec.ts}      & 6              & 48             & 100.0 \\
    Discussion         & \texttt{discussion-thread.entity.spec.ts} & 8         & 86             & 95.3 \\
    Reviews            & \texttt{review.entity.spec.ts}       & 6              & 52             & 100.0 \\
    Reviews            & \texttt{review-eligibility.service.spec.ts} & 5         & 44             & 100.0 \\
    \midrule
    \textbf{Total}     & (19 files)                          & \textbf{173}   & \textbf{1794}  & \textbf{98.5} \\
    \bottomrule
  \end{tabular}
\end{table}
